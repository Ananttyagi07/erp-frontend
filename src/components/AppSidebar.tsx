        ...
        <div className="p-4 border-b border-sidebar-border">
          {!isCollapsed && (
            <div className="flex items-center gap-2">
              <School className="h-8 w-8 text-sidebar-foreground" />
              <div>
                <h2 className="text-lg font-bold text-sidebar-foreground">EduManage</h2>
                <p className="text-xs text-sidebar-foreground/70">School Management</p>
              </div>
            </div>
          )}
          {isCollapsed && <School className="h-6 w-6 text-sidebar-foreground mx-auto" />}
        </div>
